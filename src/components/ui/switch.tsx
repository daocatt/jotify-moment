  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "data-checked:bg-green-500 data-checked:border-transparent",
        "data-unchecked:bg-zinc-200 dark:data-unchecked:bg-zinc-700 data-unchecked:border-zinc-300/80 dark:data-unchecked:border-zinc-600",
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          "data-checked:bg-white dark:data-checked:bg-white",
          "data-unchecked:bg-white dark:data-unchecked:bg-zinc-300 data-unchecked:shadow-[0_1px_2px_rgba(0,0,0,0.25)]"
        )}
      />
    </SwitchPrimitive.Root>
  )
