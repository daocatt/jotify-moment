...
const VALID_SETTING_KEYS = ["allow_registration", "require_approval", "global_theme", "telegram_bot_name", "telegram_bot_token", "telegram_webhook_secret", "allow_custom_domains", "friends_circle_enabled", "dalao_oauth_enabled"];
...
export async function getPublicSettingsAction() {
  try {
    const PUBLIC_KEYS = ["allow_registration", "require_approval", "global_theme", "friends_circle_enabled", "dalao_oauth_enabled"];
